    ...
    <div className="flex flex-col justify-center ">
      <div className="flex md:flex-row flex-col-reverse w-full items-center md:items-start justify-center ">
        ...
        <div className="flex flex-col basis-5/12 items-center justify-center gap-4">
          ...
          <p className="text-center md:text-left mb-8 md:mb-0 p-0 w-11/12 md:max-w-md">
      ...
      <div className="pt-8 md:pt-16 lg:pt-[150px]" />
      ...
      <div className="text-3xl font-bold pb-3 mt-4 md:mt-0 mb-4 md:mb-0">
        <Heading text={"Join HLG@UCR"} />
      </div>

      <div className="flex flex-row justify-center pt-2 bg-hlg-gray h-30 pb-4">
