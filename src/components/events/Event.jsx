...
const Event = ({month = 'FEB', day='29', time = '7:00PM', title ='Event Title',
              link = 'http://google.com', description = 'Lorem ipsum dolor hello this is a test for the lol',color = 'bg-orange-400'}) => {  const [info, setInfo] = useState({
  month: month,
  day: day,
  time: time,
  title: title,
